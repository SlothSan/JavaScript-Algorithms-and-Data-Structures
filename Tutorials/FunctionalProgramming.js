...
/*ombine an Array into a String Using the join Method
...
function urlSlug(title) {
  return title 
          .toLowerCase() // forces lower case.
          .trim() //takes whitespace out.
          .split(/\s+/) // Match a single whitespacecharacter (tab, line feed, carriage return,   vertical tab, form feed) between one and unlimmited times. (greedy)
          .join("-")
